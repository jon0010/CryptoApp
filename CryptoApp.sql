...
-- Started on 2024-07-02 19:35:25
...
-- Name: users_crypto; Type: TABLE; Schema: public; Owner: postgres
--
...
ALTER TABLE public.users_crypto OWNER TO postgres;

--
-- TOC entry 4841 (class 0 OID 16431)
-- Dependencies: 217
...
218	TR	TÃœRKIYE	TÃ¼rkiye, The Republic of	TUR	792	90
...
-- Dependencies: 215
-- Data for Name: users_crypto; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.users_crypto (usuario, nombre, apellido, email, password) FROM stdin;
usuario	nombre2	apellido	correo	contraseña1233
\.
...
--
-- TOC entry 4695 (class 2606 OID 16437)
...
-- Completed on 2024-07-02 19:35:25
